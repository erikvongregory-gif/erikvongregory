...
export const TAPS: TapWallItem[] = [
  {
    ...
    body: "Studio-Qualität ohne Studio. Flasche, Dose, Glas — im Starter-Paket mit 15 Motiven in deinem Markenstil.",
    deliv: "Starter · 15 Motive · 890 €",
  },
  {
    n: "02",
    label: "Kampagne",
    ...
    body: "Saison-, Event- und Themen-Sets als konsistente Bildserien — im Wachstumspaket mit 30 Motiven und Posts für Feed und Ads.",
    deliv: "Wachstum · 30 Motive · 1.690 €",
  },
  {
    n: "03",
    label: "Betrieb",
  ...
  },
  {
    ...
    body: "Onepager mit Texten, Struktur und Social-Setup — im Brauerei-Premium-Paket inkl. 40 KI-Produktbildern und 20 Posts.",
