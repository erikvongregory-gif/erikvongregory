...
export function DesktopHero() {
  return (
    <section
      ...
      data-section="start"
      className="relative overflow-hidden bg-[#15110C] text-paper"
    >
...
function GeneratorMockup() {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute -bottom-7 -left-7 rotate-[-2.5deg] rounded-[14px] bg-paper p-[14px_18px] text-ink shadow-2xl">
