  ...
  return (
    <div className="about-root bg-paper text-ink">
      <main className="pt-[68px]">
        <section id="about-hero" aria-labelledby="about-hero-h1" className="relative overflow-hidden bg-[#15110C] text-paper">
        ...
        <section id="hintergrund" aria-labelledby="about-hintergrund-h2" className="scroll-mt-24 py-[120px]">
          <DesktopContainer>
            <div className="grid grid-cols-[1fr_1.4fr] items-end gap-16 border-b border-ink/10 pb-14">
              <div>
            ...
            <div className="grid grid-cols-[1fr_1.4fr] items-start gap-16 pt-[72px]">
              <div>
        ...
        <section id="about-hugo" aria-labelledby="about-hugo-h2" className="relative overflow-hidden bg-[#0F0C08] py-[120px] text-paper">
          ...
          <DesktopContainer className="relative">
            ...
            <div className="grid grid-cols-[1fr_1.05fr] items-start gap-[72px] pt-[72px]">
              <div>
        ...
        <section aria-labelledby="about-satz-h2" className="py-[140px]">
          <DesktopContainer className="max-w-[1080px]">
            ...
            <p className="mx-auto mt-9 max-w-[640px] text-center text-[17.5px] leading-[1.55] text-ink2">
              Schnell genug für Social, stark genug für Kampagnen und Clips. Was uns wichtig ist: dass ihr euch verstanden
              fühlt und am Ende Assets habt, die wirklich einsetzbar sind — nicht nur „nice" aussehen.
            </p>
            ...
            <div className="grid grid-cols-2 gap-14 pt-[72px]">
              <div className="space-y-[18px]">
                {[
                  ...
                  <div key={card.kicker} className="rounded-2xl border border-ink/10 bg-white p-[24px_26px]">
              ...
              <div>
                <div className="rounded-2xl border border-ink/10 bg-white p-[22px]">
                  <div className="mb-4 flex justify-between font-mono-hero text-[10px] uppercase tracking-wider text-ink3">
                    <span>Region · DACH</span>
                    <span className="text-amber">● 12+ Brauereien</span>
                  </div>
                ...
                <div className="mt-[18px] overflow-hidden rounded-2xl border border-ink/10 bg-white">
                  {DACH_STAEDTE.map((row, i) => (
                    <div
                      key={row.stadt}
                      className={cn(
                        "grid grid-cols-[38px_1fr_1fr_110px] gap-3 px-[18px] py-3 text-sm",
                    ...
                    >
                      ...
                      <span
                        className={cn(
                          "text-right font-mono-hero text-[10px] uppercase",
                          row.mode === "Premium" ? "text-amber" : "text-ink3",
                        )}
                      >
                        {row.mode}
                      </span>
        ...
        <section id="about-closing" aria-labelledby="about-closing-h2" className="bg-[#15110C] py-[120px] text-paper">
          ...
          <DesktopContainer>
            <div className="grid grid-cols-[1.4fr_1fr] gap-16 border-b border-[rgba(244,239,230,0.08)] pb-16">
              <div>
            ...
            <div className="flex justify-between pt-8 font-mono-hero text-[11px] uppercase tracking-wider text-[#8C7E68]">
