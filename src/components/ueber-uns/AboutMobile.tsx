    ...
    <div className="about-root mobile-root bg-paper text-ink">
        <section id="about-hero" className="relative overflow-hidden bg-[#15110C] pb-10 pt-20 text-paper">
          ...
          <div className="relative px-[22px] pt-4">
            <div className="border-b border-[rgba(244,239,230,0.08)] pb-6 font-mono-hero text-[9.5px] uppercase tracking-[1.2px] text-[#8C7E68]">
              <p>EvGlab · Über uns · №07</p>
              <p className="mt-1">Brauereien · DACH · Mai 26</p>
            </div>
            <p className="mt-6 flex items-center gap-2 font-mono-hero text-[10px] uppercase text-[#8C7E68]">
              <span className="h-1 w-1 rounded-full bg-amber" aria-hidden />
              Marke & Team
            </p>
            <h1 className="mt-4 font-serif-hero text-[44px] font-normal leading-[0.98] tracking-[-1.6px]">
              KI-Marketing
              <br />
            ...
            <p className="mt-5 text-[15.5px] leading-[1.55] text-[#C8BFAD]">
            ...
            <div className="mt-10 grid grid-cols-2 gap-4 border-t border-[rgba(244,239,230,0.08)] pt-6">
              {HERO_STATS.map(([v, l]) => (
                <div key={l}>
        ...
        <section id="hintergrund" className="scroll-mt-24 px-[22px] py-10">
          ...
          <blockquote className="mt-6 border-l-[3px] border-amber pl-4 font-serif-hero text-[21px] italic leading-snug text-ink">
            Wie bekommen Brauereien schneller <span className="text-amber">gute Werbemotive</span> — ohne Wochen
            interner Kapazität?
          </blockquote>
          <p className="mt-5 text-[14.5px] leading-[1.65] text-ink2">
            KI ist das Werkzeug — wenn Briefing, Markenprofil und Freigaben sitzen. Daraus entstand EvGlab.
          </p>
          <p className="mt-4 text-[14.5px] leading-[1.65] text-ink2">
            Heute: fertige Assets, Pakete und ein Dashboard mit Token-Abo für laufenden Bedarf.
          </p>
          <div className="mt-6 rounded-[14px] border border-ink/10 bg-white p-4">
        ...
        <section id="about-hugo" className="bg-[#0F0C08] px-[22px] py-10 text-paper">
          ...
          <div className="mt-6 space-y-3 rounded-2xl border border-[#2C2519] bg-[#1A150E] p-4">
          ...
          <button
            ...
            className="mt-6 w-full rounded-xl bg-amber py-3.5 font-sans-tight text-sm font-semibold text-[#15110C]"
          >
        ...
        <section className="px-[22px] py-10 text-center">
          <p className="font-mono-hero text-[10px] uppercase tracking-wider text-amber">EvGlab in einem Satz</p>
          <blockquote className="mt-5 font-serif-hero text-[30px] leading-snug tracking-tight">
        ...
        <section id="about-closing" className="bg-[#15110C] px-[22px] py-10 text-paper">
          ...
          <p className="font-mono-hero text-[10px] uppercase text-amber2">Genug gelesen?</p>
          <h2 className="mt-3 font-serif-hero text-[32px] leading-tight">
          ...
          <div className="mt-8 space-y-2">
            {KONTAKT_KANAALE.map((k) => (
              <a
                ...
                className="block rounded-xl border border-[#2C2519] bg-[#1A150E] p-4"
              >
