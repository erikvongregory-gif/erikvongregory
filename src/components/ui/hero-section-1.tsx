  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
        <div
          aria-hidden
          className="isolate absolute inset-0 z-[2] hidden opacity-50 contain-strict pointer-events-none lg:block"
        >
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <img
                ...
                alt="Nachtaufnahme einer Brauerei"
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                    ...
                    einsetzbar und auf Sichtbarkeit ausgelegt.
                  </p>
                </AnimatedGroup>
                ...
                >
                  ...
                  <Button key={2} asChild size="lg" variant="ghost" className="h-10.5 rounded-xl px-5">
                    <Link href="#section-4">
                      <span className="text-nowrap">Meine Angebote</span>
                    </Link>
                  </Button>
                </AnimatedGroup>
              </div>
              ...
              <div className="relative mt-8 -mr-56 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="relative mx-auto max-w-6xl overflow-hidden rounded-2xl border bg-background p-4 shadow-lg shadow-zinc-950/15 ring-1 ring-background inset-shadow-2xs dark:inset-shadow-white/20">
                  <img
                    ...
                    src="https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=2200&q=80"
                    alt="Brauerei Kampagnen-Dashboard"
                    width="2700"
                    height="1440"
                  />
                  <img
        ...
        <section className="bg-background pb-16 pt-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
              <Link href="#echte-beispiele-aus-der-praxis" className="block text-sm duration-150 hover:opacity-75">
                <span>Echte Praxisbeispiele ansehen</span>
            ...
            <div className="mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 group-hover:blur-xs sm:gap-x-16 sm:gap-y-14">
              {[
                ...
                <div key={item} className="flex items-center justify-center rounded-md border border-zinc-200/70 px-3 py-2 text-xs text-zinc-600">
                  {item}
                </div>
              ))}
            </div>
...
const menuItems = [
  { name: "Features", href: "#section-2" },
  { name: "Angebote", href: "#section-4" },
  { name: "Praxisbeispiele", href: "#echte-beispiele-aus-der-praxis" },
