...
export function Header() {
  ...
  return (
    <header
      className={cn("sticky top-0 z-50 hidden w-full border-b border-transparent md:block", {
        "bg-background/95 border-border backdrop-blur-lg supports-[backdrop-filter]:bg-background/50":
          scrolled,
      })}
    >
