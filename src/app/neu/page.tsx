...
export const metadata: Metadata = {
  ...
  description:
    "BrewAI ist das KI-Content-System für Brauereien: planbare Produktbilder, Kampagnen und Social-Content für mehr Sichtbarkeit und klare Marken.",
  robots: { index: false, follow: false },
  alternates: { canonical: `${SITE.baseUrl}/neu` },
  openGraph: {
    title: "BrewAI lässt Brauereien wachsen | KI-Content-System",
    description:
      "Planbare Produktbilder, Kampagnen und Social-Content für Brauereien — mehr Sichtbarkeit, klare Marke, weniger Aufwand.",
